#!/usr/bin/env python3
"""
Safe fallback builder for player_form.csv that does NOT replace your current builder.
It composes from outputs generated by make_all.py. Exact output columns:
